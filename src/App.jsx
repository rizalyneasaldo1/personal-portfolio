              ...
              <div className="container-narrow">
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <p>
                      I am passionate about UI/UX design and Web Design. I am a
                      skilled front-end developer and master of graphic design tools
                      such as Photoshop and Sketch. I am a quick learner and a team
                ...
                <div className="row">
                  ...
                  >
                    <div className="d-flex ms-md-3">
                      <span>
                        <i className="fas fa-2x fa-quote-left" />
                      </span>
                      <span className="m-2">
                        Walter displays exemplary professionalism and is able to take
                        on challenges. He learns quickly and is an asset to any team.
                      </span>
                    </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6" data-aos="fade-left" data-aos-delay={300}>
                    <div className="mt-3 px-1">
                      ...
                      <p>
                        If you like my work and want to avail my services then drop me
